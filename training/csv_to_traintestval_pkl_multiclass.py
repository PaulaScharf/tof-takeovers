...
labeled_datasets_paths = [
    ...
    ['./training/trainingsdata/labeled/luca/Fahrraeder_multiclass.csv',True],
...
for [path, undersample] in labeled_datasets_paths:
    ...
    if undersample:
        ...
        class_1_data = data[data['Label'] != 0]
        class_0_temp = temp[temp['Label'] == 0]
        class_1_temp = temp[temp['Label'] != 0]
...
# save data locally
with open('./training/trainingsdata/traintestval/multiclass/train_data.pkl', 'wb') as file:
    pickle.dump((X_train, y_train), file)

with open('./training/trainingsdata/traintestval/multiclass/test_data.pkl', 'wb') as file:
    pickle.dump((X_test, y_test), file)

with open('./training/trainingsdata/traintestval/multiclass/val_data.pkl', 'wb') as file:
